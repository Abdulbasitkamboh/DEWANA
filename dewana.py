#!/usr/bin/python2
#coding=utf-8
#Codded By ABDUL BASIT 
#Editing My Script Will Not Make You A Coder
#Facebook : ABHI NAHII WAIT 
#Whatsapp : NEVER
...
\x1b[1;96mBASIT
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  YouTube  : I HAVE NO
\x1b[1;94m➣  Facebook : PLEASE WAIT...
\x1b[1;94m➣  Note     : Dont ReEdit It 
\x1b[1;94m➣  Github   : https://github.com/Abdulbasitkamboh/DEWANA
\x1b[1;94m➣  Whatsapp : +971528752764
\x1b[1;94m➣  Note     : Having Problem? WAIT...
...
CorrectUsername = "ABDUL"
CorrectPassword = "BASIT"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:ABDUL_BASIT
	    time.sleep(1)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;97m👉 : \033[1;97mABDUL BASIT KAMBOH KING OF THE FACEBOOK' ) 
...
def menu():
	...
	print "\033[1;97m✧\033[1;97m.\033[1;97m1.\x1b[1;97m Start Cloning..."
        ...
        print "\033[1;97m✧\033[1;97m.\033[1;97m2.\033[1;97m Follow Me On World For Help"
